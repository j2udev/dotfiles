...
alias dim='nvim $XDG_CONFIG_HOME/dotfiles/zsh/zshrc'
alias dima='nvim $XDG_CONFIG_HOME/dotfiles/zsh/aliases.zsh'
alias dime='nvim $XDG_CONFIG_HOME/dotfiles/zsh/exports.zsh'
alias dimf='nvim $XDG_CONFIG_HOME/dotfiles/zsh/functions.zsh'
alias dimp='nvim $XDG_CONFIG_HOME/dotfiles/zsh/plugins.zsh'
alias dimm='nvim $XDG_CONFIG_HOME/dotfiles/zsh/misc.zsh'
alias nim='nvim $XDG_CONFIG_HOME/dotfiles/nvim/init.vim'
alias nims='nvim $XDG_CONFIG_HOME/dotfiles/nvim/settings.vim'
