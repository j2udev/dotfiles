...
typeset -g wvublue='#002855'
typeset -g wvugold='#EAAA00'
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{$wvublue}%f'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND="$wvugold"
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="$wvugold"
  typeset -g POWERLEVEL9K_DIR_BACKGROUND="$wvublue"
...
#  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND="$wvugold"
...
#  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=76
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR="$wvublue"
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND="$wvublue"
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND="$wvugold"
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND="$wvublue"
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND="$wvugold"
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND="$wvublue"
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND="$wvugold"
  ...
  ##################################[ context: user@hostname ]##################################
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND="$wvugold"
